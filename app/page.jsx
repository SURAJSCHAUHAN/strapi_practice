      ...
      <div className='flex mt-6 '>
        <div className='relative flex h-[55vh] w-[40vw]'>
            ...
            <div className='absolute h-full right-0 flex w-[25vw] rounded-full text-white justify-center text-lg'>
              <img className='w-full h-full rounded-full object-cover' src={item.Image? `${item.Image.data.attributes.url}`:'https://media.istockphoto.com/id/613241758/photo/young-woman-working-on-a-laptop.jpg?s=612x612&w=0&k=20&c=B3WbJ7VFEr77G0T698I0WMkM5LOV-pMrLCljEEJGh-o='} alt="" />
            </div>
        </div>
